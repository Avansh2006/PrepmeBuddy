    ...
    >
      ...
      <div className="relative z-10 max-w-md w-full space-y-6">
        <header className="text-center">
          <h1
            id="signup-title"
            className="text-3xl font-extrabold text-gray-100 tracking-tight md:text-4xl bg-gradient-to-r from-gray-100 to-indigo-400 bg-clip-text text-transparent"
          >
            Join the Journey
          </h1>
        ...
        <div
          className={`bg-zinc-800/95 backdrop-blur-sm rounded-lg shadow-2xl p-6 border border-zinc-700/50 ${ANIMATION_CLASSES.signUp}`}
          role="region"
          ...
          <SignUp
            ...
            appearance={{
              elements: {
                ...
                formFieldInput:
                  "bg-zinc-900 border-zinc-600 text-gray-100 rounded-md focus:ring-2 focus:ring-indigo-500",
              },
            }}
